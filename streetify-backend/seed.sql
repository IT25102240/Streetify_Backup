...
DELETE FROM trips;
DELETE FROM users WHERE email IN ('passenger1@test.com', 'passenger2@test.com', 'driver1@test.com', 'driver2@test.com');

-- 1. Insert Dummy Users (Passengers)
